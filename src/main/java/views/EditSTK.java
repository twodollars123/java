 ...
 * @author PC
 */
public class EditSTK extends javax.swing.JFrame {

    private ArrayList<SachThamKhoa> list;

    public EditSTK() {
        initComponents();
    }

    public void setEditData(SachThamKhoa s) {
        ...
        txtThue.setText(String.valueOf(s.getThue()));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Sửa thông tin sách tham khoa");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        s.setThue(Float.parseFloat(txtThue.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditSTK.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
